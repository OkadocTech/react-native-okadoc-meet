...
public class RNOkadocMeetView extends BaseReactView<JitsiMeetViewListener>
        implements RNOngoingConferenceTracker.OngoingConferenceListener {

    /**
     * The {@code Method}s of {@code OkadocMeetViewListener} by event name i.e.
     * redux action types.
     */
    ...
    public RNOkadocMeetView(@NonNull Context context) {
        super(context);
    ...
    /**
     * Joins the conference specified by the given {@link RNOkadocMeetConferenceOptions}. If there is
     ...
     *                when doing so.
     */
    public void join(@Nullable RNOkadocMeetConferenceOptions options) {
