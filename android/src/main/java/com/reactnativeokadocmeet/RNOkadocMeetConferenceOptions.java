...
/**
 * This class represents the options when joining a Okadoc Meet conference. The user can create an
 * instance by using {@link RNOkadocMeetConferenceOptions.Builder} and setting the desired options
 * there.
 *
 * The resulting {@link RNOkadocMeetConferenceOptions} object is immutable and represents how the
 * conference will be joined.
 */
public class RNOkadocMeetConferenceOptions implements Parcelable {
    /**
    ...
    /**
     * Color scheme override, see: https://github.com/okadoc/okadoc-meet/blob/dbedee5e22e5dcf9c92db96ef5bb3c9982fc526d/react/features/base/color-scheme/defaultScheme.js
     */
    private Bundle colorScheme;

    /**
     * Feature flags. See: https://github.com/okadoc/okadoc-meet/blob/master/react/features/base/flags/constants.js
     */
     ...
     */
    private RNOkadocMeetUserInfo userInfo;

    /**
     * Class used to build the immutable {@link RNOkadocMeetConferenceOptions} object.
     */
    public static class Builder {
         ...
         * https://github.com/okadoc/okadoc-meet/blob/master/react/features/base/color-scheme/defaultScheme.js
         * for the structure.
        ...
        public Builder setUserInfo(RNOkadocMeetUserInfo userInfo) {
        ...
        /**
         * Builds the immutable {@link RNOkadocMeetConferenceOptions} object with the configuration
         * that this {@link Builder} instance specified.
         * @return - The built {@link RNOkadocMeetConferenceOptions} object.
         */
        public RNOkadocMeetConferenceOptions build() {
            RNOkadocMeetConferenceOptions options = new RNOkadocMeetConferenceOptions();
    ...
    private RNOkadocMeetConferenceOptions() {
    }

    private RNOkadocMeetConferenceOptions(Parcel in) {
        room = in.readString();
        subject = in.readString();
        token = in.readString();
        colorScheme = in.readBundle();
        featureFlags = in.readBundle();
        userInfo = new RNOkadocMeetUserInfo(in.readBundle());
    ...
    public static final Creator<RNOkadocMeetConferenceOptions> CREATOR = new Creator<RNOkadocMeetConferenceOptions>() {
        @Override
        public RNOkadocMeetConferenceOptions createFromParcel(Parcel in) {
            return new RNOkadocMeetConferenceOptions(in);
        }

        @Override
        public RNOkadocMeetConferenceOptions[] newArray(int size) {
            return new RNOkadocMeetConferenceOptions[size];
        }
    };
